"""
Django settings for Garbage_detection project.
...
#!!!!!!! you should use a different (secure) SECRET_KEY for production.
SECRET_KEY = 'django-insecure-f4ywhi1_2284f&k)gbsg8y1@*&$hp+w4zamc5^3xvfea+m@ov@'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'MMC',         # your database name
        'USER': 'MMC',        # your database user
